    ...
    public class frmClient : System.Windows.Forms.Form
    {
		...
		private int PopulateList()
		{
			try 
			{
				...
				xmlServerComm.WriteDataToFile(xmlParser.USERLISTXML,xmlServerComm.GetDataFromServer("http://SERVERNAME/p2p/userlist.asp"));
		...
		protected void btnSearch_Click (object sender, System.EventArgs e)
		{
			try
			{
				...
				if( System.Windows.Forms.DialogResult.OK == SearchForm.ShowDialog() )
				{
					...
					xmlServerComm.WriteDataToFile(xmlParser.SERVERSEARCHRESULTXML,xmlServerComm.GetDataFromServer("http://SERVERNAME/p2p/search.asp?US=" + SearchForm.SearchOn + "&FS=" + SearchForm.SearchFor));
        ...
        /// </summary>
		[STAThread]
	    public static void Main(string[] args) { Application.Run(new frmClient()); }
    }
}